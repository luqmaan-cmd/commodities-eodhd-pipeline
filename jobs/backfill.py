"""Backfill entry point — one-time load of all historical commodity data."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="EODHD Commodities Pipeline — Backfill"
    )
    parser.add_argument(
        "--symbol",
        type=str,
        default=None,
        help="Process only this symbol (e.g. GC). Useful for test runs.",
    )
    parser.add_argument(
        "--workers",
        type=int,
